...
public class MallDao extends SuperDao{
	...
	public void Calculate(Member mem, Map<Integer, Integer> maplists, int totalPoint) {
		// mem객체는 고객 정보이고, maplists 객체는 구매한 상품 리스트 입니다.
		...
		try {
			...
			for(Integer pnum : keylist) {
				// 3. 반복문을 사용하여 주문 상세(orderdetails) 테이블에 추가합니다.
				// order.oid와 orderdetails의 oid는 동일한 값입니다.
	...
	public List<ShoppingInfo> GetShoppingInfo(String id) {
		// ShoppingInfos 테이블에세 로그인한 사람의 장바구니 정보 가져오기
